...
@SuppressLint("NewApi")
public class EventList<SearchResultActivity> extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("QR_SCAN_HISTORY","activity_event_list entering ");
				...
				DatePickerDialog dpd = new DatePickerDialog(this,
				        new DatePickerDialog.OnDateSetListener() {
				            ...
				            public void onDateSet(DatePicker view, int year,
								...
								if(mContact.size() == 0)
								{
									util.savePreference(EventList.this,"SyncForDate",SyncForDate);
								}				 
				            }
				        }, mYear, mMonth, mDay);
				dpd.show();
					...
					DatePickerDialog dpd_ = new DatePickerDialog(this,
							new DatePickerDialog.OnDateSetListener() {
								...
								public void onDateSet(DatePicker view, int year,
									...
									if(mContact.size() == 0)
									{
										util.savePreference(EventList.this,"SyncFromDate",dateFrom);
									}				 
								}
							}, mYear, mMonth, mDay);
					dpd_.show();
			...
			builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					// Do nothing but close the dialog
						db.deleteAllContact();
					int index = 0;
					util.savePreference(EventList.this, "NwUpdatedIndex", ""+index);
					dialog.dismiss();
				}
