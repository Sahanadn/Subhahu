...
@SuppressLint("NewApi")
public class AttendenceList<SearchResultActivity> extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String userName = util.getPreference(AttendenceList.this,"client_userName",null);
		...
		ArrayAdapter<String> date_dataAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, dates);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
				...
				DatePickerDialog dpd = new DatePickerDialog(this,
				        new DatePickerDialog.OnDateSetListener() {
				            ...
				            public void onDateSet(DatePicker view, int year,
								...
								if(mContact.size() == 0)
								{
									util.savePreference(AttendenceList.this,"SyncForDate",SyncForDate);
								}				 
				            }
				        }, mYear, mMonth, mDay);
				dpd.show();
			...
			{
					String dateFrom = "2016-07-30";
					Log.d("QR_SCAN_HISTORY", "SyncFromDate "+dateFrom);
					...
					DatePickerDialog dpd_ = new DatePickerDialog(this,
							new DatePickerDialog.OnDateSetListener() {
								...
								public void onDateSet(DatePicker view, int year,
									...
									if(mContact.size() == 0)
									{
										util.savePreference(AttendenceList.this,"SyncFromDate",dateFrom);
									}				 
								}
							}, mYear, mMonth, mDay);
					dpd_.show();
			...
			builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					// Do nothing but close the dialog
						db.deleteAllContact();
					int index = 0;
					util.savePreference(AttendenceList.this, "NwUpdatedIndex", ""+index);
					dialog.dismiss();
				}
